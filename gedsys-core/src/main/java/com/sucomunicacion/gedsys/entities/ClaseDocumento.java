 ...
 */
@Entity
@Table(name = "ClaseDocumento", catalog = "gedsys", schema = "dbo")
@XmlRootElement
@NamedQueries({
...
public class ClaseDocumento implements Serializable {
    ...
    @OneToMany(mappedBy = "claseDocumento")
    private Collection<Documento> documentoCollection;

    public ClaseDocumento() {
    }

    public ClaseDocumento(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ClaseDocumento)) {
            return false;
        }
        ClaseDocumento other = (ClaseDocumento) object;
    ...
    public String toString() {
        return "com.sucomunicacion.gedsys.entities.ClaseDocumento[ id=" + id + " ]";
    }
